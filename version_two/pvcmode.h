...
class pvcmode:public QGraphicsScene{
    Q_OBJECT
    friend class menu;
public:
    pvcmode();
...
private:
    ...
    int BulletmoveTimer;
    int BulletshootTimerid;
    int BulletshootTimerid2;
    int BulletshootTimerid3;
    int BulletshootTimerid4;
    int BulletshootTimerid5;
    ...
    static bool cmp1(Bullet* a,Bullet* b);
